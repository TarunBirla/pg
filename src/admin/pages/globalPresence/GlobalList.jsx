...
export default function GlobalList() {
  ...
  const totalEntries = filteredglobal.length;
  const totalPages = Math.ceil(totalEntries / entries);
  const startIndex = (currentPage - 1) * entries;
  const endIndex = Math.min(startIndex + entries, totalEntries);
  const currentglobal = filteredglobal.slice(startIndex, endIndex);
                ...
                currentglobal.map((global) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      ...
                      >
                        {global.active === true ? "Active" : "Inactive"}
                      </span>
                    </td>
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-2">
